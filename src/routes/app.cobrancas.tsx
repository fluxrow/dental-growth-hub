              ...
              return (
                <tr key={c.id} className="hover:bg-muted/30">
                  ...
                  <td className="px-4 py-3 tabular-nums text-muted-foreground">
                    {c.dueDate}
                    {c.daysOverdue && (
                      <span className="ml-2 text-[11px] text-destructive">+{c.daysOverdue}d</span>
                    )}
                  </td>
          ...
          {[
            ...
            <div key={a.t} className="rounded-lg border border-border bg-background p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10.5px] uppercase tracking-wider text-success font-semibold">
                  Ativa
                </span>
              </div>
