  ...
  return (
    ...
    >
      ...
      <div className="rounded-xl border border-border bg-surface overflow-hidden">
              ...
              <div key={c.id} className="px-4 py-3">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <div className="text-sm-minus font-medium truncate">{c.name}</div>
                  ...
                  <div className="shrink-0 text-right">
                    ...
                    <div className="text-2xs text-primary font-medium tabular-nums mt-0.5">
                      {conv}% conversão
                    </div>
                  </div>
                </div>
                <div className="text-2xs text-muted-foreground tabular-nums mt-1.5">
                  {c.sent} enviadas · {((c.opened / c.sent) * 100).toFixed(0)}% abertura ·{" "}
                  {((c.responded / c.sent) * 100).toFixed(0)}% resposta
                </div>
              </div>
            );
          })}
        ...
        <table className="hidden md:table w-full text-sm-minus">
