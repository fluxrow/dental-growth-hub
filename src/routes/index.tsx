    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 pb-16 lg:pt-28 lg:pb-24">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-border bg-surface px-3 py-1 text-[12px] text-muted-foreground mb-6">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <a
              href="#funil"
              className="inline-flex items-center gap-1.5 h-11 px-5 rounded-md border border-input bg-surface text-[14px] font-medium hover:bg-muted"
            >
              Ver como funciona
            </a>
          </div>
        ...
        <div className="grid grid-cols-12 min-h-[420px]">
          ...
          <div className="col-span-12 md:col-span-9 p-5 bg-background">
            <div className="flex items-center justify-between mb-4">
              <div>
                <div className="text-[13px] font-semibold">Visão geral</div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
              {[
                ...
                <div key={k.l} className="rounded-lg border border-border bg-surface p-3">
                  ...
                  <div className={`text-[10px] tabular-nums ${k.c}`}>{k.d}</div>
                </div>
              ))}
            </div>
...
function SocialProof() {
  return (
    <section className="border-y border-border bg-surface-muted">
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-muted-foreground text-[12px]">
  ...
  return (
    <section id="problema" className="py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <div className="inline-block text-[12px] font-medium text-primary mb-3">O problema</div>
    ...
    <section className="py-20 lg:py-24 bg-surface-muted/50 border-y border-border">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="text-[12px] font-medium text-primary mb-3">Como funciona</div>
...
function FunnelSection() {
  ...
  return (
    <section id="funil" className="py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="text-[12px] font-medium text-primary mb-3">O Funil DentalFlux</div>
          <h2 className="font-display text-3xl lg:text-4xl font-semibold tracking-tight">
...
function Benefits() {
  ...
  return (
    <section id="beneficios" className="py-20 lg:py-28 bg-surface-muted/50 border-y border-border">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="text-[12px] font-medium text-primary mb-3">Benefícios</div>
          <h2 className="font-display text-3xl lg:text-4xl font-semibold tracking-tight">
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="rounded-2xl border border-border bg-gradient-to-br from-surface to-accent/30 p-8 lg:p-12">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <div className="text-[12px] font-medium text-primary mb-3">Resultados</div>
            <h2 className="font-display text-3xl lg:text-4xl font-semibold tracking-tight">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((s) => (
              <div key={s.l} className="text-center">
                ...
                <div className="mt-2 text-[12.5px] text-muted-foreground leading-snug">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
    ...
    <section className="py-20 lg:py-24 bg-surface-muted/50 border-y border-border">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="text-[12px] font-medium text-primary mb-3">Depoimentos</div>
          <h2 className="font-display text-3xl lg:text-4xl font-semibold tracking-tight">
  ...
  return (
    <footer className="border-t border-border bg-surface-muted/40">
      ...
      <div className="border-t border-border">
        <div className="max-w-6xl mx-auto px-6 py-5 text-[12px] text-muted-foreground flex flex-wrap justify-between gap-3">
