  ...
  return (
    <div className="flex min-h-screen w-full bg-background text-foreground">
      ...
      <aside className="hidden md:block w-16 shrink-0">
        <div className="group/sb fixed inset-y-0 left-0 z-40 flex w-16 hover:w-[240px] focus-within:w-[240px] transition-[width] duration-200 ease-out flex-col border-r border-border bg-sidebar overflow-hidden">
          <Link
            to="/"
          ...
          <div className="px-3 py-2">
            <button className="w-full flex items-center gap-2 px-1.5 py-2 rounded-md hover:bg-sidebar-accent text-left">
              ...
              <div className="flex-1 min-w-0 opacity-0 group-hover/sb:opacity-100 group-focus-within/sb:opacity-100 transition-opacity duration-150">
              ...
              <ChevronDown className="size-3.5 shrink-0 text-muted-foreground opacity-0 group-hover/sb:opacity-100 group-focus-within/sb:opacity-100 transition-opacity duration-150" />
            </button>
          </div>
          <nav className="flex-1 overflow-y-auto overflow-x-hidden px-2 pb-4 pt-2 space-y-1">
            {NAV_GROUPS.map((group) => (
              <div key={group.label}>
                <div className="px-2 py-1.5 text-3xs font-semibold tracking-wider text-muted-foreground/60 uppercase whitespace-nowrap opacity-0 group-hover/sb:opacity-100 group-focus-within/sb:opacity-100 transition-opacity duration-150">
                  {group.label}
                </div>
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="whitespace-nowrap opacity-0 group-hover/sb:opacity-100 group-focus-within/sb:opacity-100 transition-opacity duration-150">
                        {item.label}
                      </span>
                    </Link>
                  );
          ...
          <div className="border-t border-sidebar-border p-3">
            <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                className="size-7 shrink-0 rounded-md hover:bg-sidebar-accent text-muted-foreground hover:text-foreground flex items-center justify-center opacity-0 group-hover/sb:opacity-100 group-focus-within/sb:opacity-100 transition-opacity duration-150"
              >
            ...
            <Link
              ...
              className="mt-2 block text-2xs text-muted-foreground hover:text-primary whitespace-nowrap opacity-0 group-hover/sb:opacity-100 group-focus-within/sb:opacity-100 transition-opacity duration-150"
            >
